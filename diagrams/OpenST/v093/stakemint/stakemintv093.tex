   ...
   % \end{umlcall}
    ...
    \begin{umlfragment}[type=alt, label=accept, name=policy, inner xsep=2]
      ...
      \begin{umlcall}[op={: acceptStakeRequest(staker, hashLock)}]{Facilitator}{Branded Token Gate}  %return={ emit StakingRequestAccpeted (staker, amountST, amountUT, nonce, unlockHeight, stakingIntentHash}
        ...
        \begin{umlcall}[op={: stake(uuid, amountST, openSTValue, hashLock, beneficiary)}]{Branded Token Gate}{OpenSTValue} % return={amountUT, nonce, unlockHeight, stakingIntentHash}
          ...
          \begin{umlcall}[type=return, op={emit StakingIntentDeclared(uuid, beneficiary, nonce, openSTvalue, amountST, amountUT, unlockHeight, StakingIntentHash, ChainIdUtility)}]{OpenSTValue}{Facilitator}
          \end{umlcall}
        \end{umlcall}
