...
\begin{tikzpicture}
  \begin{umlseqdiag}
    ...
    \umlobject[class=SK]{Core}
    \umlcontrol[class=SK]{Registrar}
    \umlactor[class=Worker, fill=purple!40]{Foundation/Mosaic}
    \umlcontrol[class=SK, fill=blue!40]{Registrar}
    \umlobject[class=SK, fill=blue!40]{Core}
