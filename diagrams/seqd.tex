...
\begin{tikzpicture}
  \begin{umlseqdiag}
    ...
    \begin{umlcall}[dt=5, op={: ConfirmStakingIntent(StakingIntentHash, uuid, amountST, amountUT, stakerProcessor, stakingProcessorNonce, unlockHeight)}]{Staking Processor}{OpenSTUtility}
      % OpenSTUtility assert valid pre-image data for StakingIntentHash
