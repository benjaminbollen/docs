...
% From here on I only added line breaks to improve diff readability in the future
...
%The height $n$ strictly increases by one every time a meta-block is committed into the core contract.
