...
Each commit on the origin blockchain by a supermajority of the validators can span an arbitrarily large measure of computation finalised on the auxiliary system. A working draft of logic, including the work on the gateway protocol, is appended to this document that will be included version 1 of this paper.
...
\begin{versionhistory}
  \vhEntry{0.0}{10.10.18}{BB|MS}{Asynchronous composition of blockchains (section 1 - 2.7)}
\end{versionhistory}
