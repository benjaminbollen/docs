...
Origin (Ethereum) is a blockchain assumed to have accountability and liveliness properties.  Origin produces blocks $O_i$. 


A meta-blockchain is defined in a \emph{core} contract on the origin blockchain.

\subsection{Running origin and auxiliary chains}
\label{subsec:mosaic}
