...
When a validator's deposit message is included on origin in meta-block height $i$, its \emph{start height} is $n_0$ and it starts in validator set $\mathcal{V}_{\mathcal{B}_{n_0}}$.\footnote{
...
When a validator $v$ sees its logout message included on origin in meta-block height $j \geq i + 1$, then its \emph{end height} is $n_e$ and it ends in validator set $\mathcal{V}_{\mathcal{B}_{n_e}}$.
