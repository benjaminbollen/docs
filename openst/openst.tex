...
% TODO do not assume a fixed set, start and explain the dynamic set from the start
% TODO what is a dynamic set of validators
...
% TODO only show finalised checkpoints on auxiliary
% TODO different types for aux and origin blocks
% TODO aux and origin should generate at a different pace
% TODO show that it does not start at genesis
% TODO do we require economic finality before we move the state from origin to aux?
% TODO show that time goes from left to right
\begin{figure}[htb]
    \centering
...
% TODO move this way up so that the concept of a dynamic validator set is known everywhere
